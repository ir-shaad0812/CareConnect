...
import { ArrowLeft, Shield, CheckCircle, Users, Lock } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Your safety is our highest priority. Learn about the measures we
              take to keep our community secure.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-[#F0F5FF] rounded-2xl p-8 text-center">
              <CheckCircle className="w-10 h-10 text-green-500 mx-auto mb-4" />
              <h3 className="font-semibold text-gray-900 mb-2">Background Checks</h3>
              <p className="text-sm text-gray-600">
                Every caregiver undergoes comprehensive background verification
            ...
            <div className="bg-[#F0F5FF] rounded-2xl p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                Identity verification ensures you always know who you are
                connecting with.
              </p>
            </div>
            <div className="bg-[#F0F5FF] rounded-2xl p-8 text-center">
              ...
              <p className="text-sm text-gray-600">
                End-to-end encryption and secure payments protect your data and
                transactions.
              </p>
            </div>
          </div>
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>Full safety documentation coming soon.</p>
          </div>
        </div>
      </section>
